...
# "torch-naut" by proto-n
# Repository: https://github.com/proto-n/torch-naut (branch: iclr2025)
...
class DictDataset(Dataset):
    """Wrapper to return dictionaries that can be combined with lighning uq box
    """
...
class UCIRegressionDataset:
    ...
    def train_dataset(self) -> DictDataset:
    ...
    def calibration_dataset(self) -> DictDataset:
    ...
    def test_dataset(self) -> DictDataset:
